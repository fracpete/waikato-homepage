...
BLOG_AUTHOR = "Peter Reutemann"  # (translatable)
BLOG_TITLE = "fracpete"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://www.cs.waikato.ac.nz/~fracpete/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://www.cms.waikato.ac.nz/~fracpete/"
BLOG_EMAIL = "fracpete at waikato dot ac dot nz"
BLOG_DESCRIPTION = "FracPete @ University of Waikato."  # (translatable)
...
DEPLOY_COMMANDS = {
    'default': [
        "rsync -rv --delete --exclude '*~' --exclude pubs --exclude acml2016 output/ fracpete@clout.cms.waikato.ac.nz:/home/fracpete/public_html",
    ]
}
